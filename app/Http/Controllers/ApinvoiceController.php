...
use App\Http\Requests\UpdateapinvoiceRequest;
...
class ApinvoiceController extends Controller
{
     ...
     */
    public function edit(apinvoice $apinvoice)
    {
        //
    }
     ...
     */
    public function update(UpdateapinvoiceRequest $request, apinvoice $apinvoice)
    {
        //
    }
